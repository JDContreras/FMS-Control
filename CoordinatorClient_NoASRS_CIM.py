...
"""
################################################################################
Funcion para iniciar las estaciones activando servicios OPC UA
################################################################################
"""        
def RunStations(N):     
    if N == 1:
...
if __name__ == "__main__":
    ...
    MC = Client("opc.tcp://192.168.43.176:4841/MC/")
    T = Client("opc.tcp://192.168.43.176:8000/T/")
    #ASRS = Client("opc.tcp://192.168.0.100:4842/ASRS/")
    Transport = Client("opc.tcp://192.168.43.251:4840/ARD/") #192.168.200.100:4840
    #QC = Client("opc.tcp://192.168.200.100:8080/QC/")
    ASS = Client("opc.tcp://192.168.43.251:4000/ASS/")
    ...
    try:
        ...
        server = Server()
        #server.set_endpoint("opc.tcp://172.17.20.94:4000/Control/")
        server.set_endpoint("opc.tcp://192.168.43.176:4000/Control/")
        server.set_server_name("Contro lserver")
        uri = "http://cap.edu.co"
