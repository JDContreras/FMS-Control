...
if __name__ == "__main__":
    ...
    MC = Client("opc.tcp://192.168.0.107:4841/MC/")
    T = Client("opc.tcp://192.168.0.100:8000/T/")
    ASRS = Client("opc.tcp://192.168.0.101:4842/ASRS/")
    Transport = Client("opc.tcp://192.168.0.101:4840/ARD/")
    QC = Client("opc.tcp://192.168.200.100:8080/QC/")
    ASS = Client("opc.tcp://192.168.0.101:4000/ASS/")
    ...
    try:
        ...
        if runserver == True:
            ...
            server.set_endpoint("opc.tcp://192.168.0.100:4000/Control/")
